...
description: "Instant deposits and withdrawals on supported chains using Tunnel"
---
...
Under the hood, Tunnel's instant bridign tech is powered by cross-chain relaying. This model results in low-cost, low-latency (1-10 seconds) cross-chain transactions. Learn more about the [Technical Details of Tunnel](/how-it-works/understanding-tunnel)
