...
Relay's instant bridging is powered by cross-chain relaying. This model results in low-cost, low-latency (1-10 seconds) cross-chain transactions. Today, users of Relay work with a Reservoir for cross-chain relaying. Applications trust Reservoir to perform cross-chain relaying, and refund money in the case of disputes. Learn more about the [Technical Details of Relay](/what-is-relay).
