...
Relay's instant bridging is powered by cross-chain relaying. This model results in low-cost, low-latency (1-10 seconds) cross-chain transactions. Today, users of Relay work with a trusted third-party provider for cross-chain relaying, such as Reservoir. Third parties escrow funds and take on reputational risk, in the case of cross-chain disputes. Learn more about the [Technical Details of Relay](/how-it-works/understanding-relay).
