...
<Tip>Tip: For advanced integrations, we recommend using Relay APIs. For simpler use cases, the [Relay SDK](/references/sdk/getting-started) automates steps and provides helpful callbacks, reducing manual effort.</Tip>
