...
<Steps>
  <Step title="Fetching Steps" icon="server">
    Call the [Get Quote API](/references/api/get-quote) to start your execution. These APIs are now deprecated: [Call API](/references/api/execute-call) and [Bridge API](/references/api/execute-bridge).
  </Step>
