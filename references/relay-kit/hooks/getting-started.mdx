...
## Hooks
Each hook is configured separately to allow for as much flexibility as possible. All hooks come with a query function that can be used outisde of a React context to fetch the data (useful when using SSR or in a context that doesn't use React).
