...
[Solana Adapter](https://github.com/reservoirprotocol/relay-kit/blob/main/packages/relay-solana-wallet-adapter): This adapter gives the sdk the ability to submit transactions on the Solana network. It does not support signing messages and under the hood it uses the [solana web3 sdk](https://solana-labs.github.io/solana-web3.js/).
