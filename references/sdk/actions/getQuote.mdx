...
const quote = await getClient()?.actions.getQuote({
  chainId: 1,
  toChainId: 1,
  currency: "0xa0b86991c6218b36c1d19d4a2e9eb0ce3606eb48", // USDC (any erc20 or native currency)
  toCurrency: "0xa0b86991c6218b36c1d19d4a2e9eb0ce3606eb48",
  value: "100000", // 100 USDC
  wallet,
  recipient: "0x0000c3caa36e2d9a8cd5269c976ede05018f0000", // Recipient address for the send, must be specified for send transactions
});
```
