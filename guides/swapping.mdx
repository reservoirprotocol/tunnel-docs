...
Once you determine where to swap from and to, the amount and the currency then you can pass everything into the [getPrice](/references/sdk/actions/get-price) or the [usePrice](/references/sdk/hooks/usePrice) hook depending on if you're using the sdk or the ui hooks:
