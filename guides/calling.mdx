...
Before we begin it's important to ensure that a contract is compatible with Relay. Please review our [contract Compatibility](/how-it-works/contract-compatibility.mdx) overview to make any necessary changes.
