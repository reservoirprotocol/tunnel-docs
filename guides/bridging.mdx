...
Once you determine where to bridge from and to, the amount and the currency then you can pass everything into the [getQuote](/references/sdk/actions/getQuote) action or [useQuote](/references/relay-kit/hooks/useQuote) hook. 
