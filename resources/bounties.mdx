...
We at Relay are committed to maintaining the highest security standards for protocol and our smart contracts. 
...
Rewards will be dependent on the severity of the bug. We always provide monetary rewards for bug the fall under these categories: 
...
Monetary reward amounts are 10% of the value at risk, with a maximum reward capped at $100,000 USD.
